...
# ACDS 16.1 203 win32 2017.04.01.08:50:14
...
# ----------------------------------------
# If FIR_3MHz_low is one of several IP cores in your
...
if [ $SKIP_COM -eq 0 ]; then
  ...
  vhdlan -xlrm $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/FIR_3MHz_low_rtl_core.vhd"                      
  vhdlan -xlrm $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/FIR_3MHz_low_ast.vhd"                           
  vhdlan -xlrm $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/FIR_3MHz_low.vhd"                               
  vhdlan -xlrm $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/FIR_3MHz_low_tb.vhd"                            
fi
