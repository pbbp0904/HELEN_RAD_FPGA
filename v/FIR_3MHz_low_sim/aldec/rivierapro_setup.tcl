...
alias com {
  ...
  eval  vcom $USER_DEFINED_COMPILE_OPTIONS       "$QSYS_SIMDIR/FIR_3MHz_low_rtl_core.vhd"                      
  eval  vcom $USER_DEFINED_COMPILE_OPTIONS       "$QSYS_SIMDIR/FIR_3MHz_low_ast.vhd"                           
  eval  vcom $USER_DEFINED_COMPILE_OPTIONS       "$QSYS_SIMDIR/FIR_3MHz_low.vhd"                               
  eval  vcom $USER_DEFINED_COMPILE_OPTIONS       "$QSYS_SIMDIR/FIR_3MHz_low_tb.vhd"                            
}
